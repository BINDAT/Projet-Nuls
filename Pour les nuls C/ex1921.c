...
int main()/*Fonctionne principale*/
{
    ...
    for (a=0; a<6; a++)/*boucle qui compte de 0 à 6 et augmente à partir de a*/
        for (b=a+1; b<7; b++)/*boucle qui compte ) partir de b avec a +1 en dessous de b7 et b s'auto incrémente*/
            if (*(fruits+a) > *(fruits+b))/*sans strcmp reprise de fruits a et b pour tri*/
            {
