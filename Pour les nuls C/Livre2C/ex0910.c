...
int main()
{
    ...
    for (alphabet = 'z'; alphabet >= 'a'; alphabet--) // boucle qui s'exécute de 'z' à 'a', en décrémentant de 1 à chaque itération
    {
        printf("%c", alphabet); // affichage de la lettre actuelle de l'alphabet à chaque itération
    }
