...
{
    f = (f- 32) / 1.8; // calcul de la température en Celsius à partir de la température en Fahrenheit en utilisant la formule de conversion
    return(f); // retour de la température convertie en Celsius
}