...
int main()
{
    struct president // déclaration de la structure
    {
        ...
        "John Adams",
        1797 // initialisation de la structure
    };
    ...
    printf("Le deuxième président est %s\n", pres2.nomPres); // affichage du nom du président
    printf("Il a pris ses fonctions en %d\n", pres2.anneeNomi); // affichage de l'année de nomination
