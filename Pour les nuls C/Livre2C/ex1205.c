...
int main()
{
    int scoremax[10]; // Déclaration d'un tableau de 10 entiers pour stocker les scores
    int x; // Déclaration d'une variable entière pour les boucles

    for (x=0; x<10; x++) // Boucle pour lire les scores
    {
    ...
    for (x=0; x<10; x++) // Boucle pour afficher les scores
