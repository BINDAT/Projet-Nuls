...
int main()
{
    ...
    int index, alpha,upper, lower, blank, punct; // index pour parcourir la phrase, les autres pour compter les différents types de caractères

    alpha = blank = punct = lower = upper = 0; // initialisation des compteurs
