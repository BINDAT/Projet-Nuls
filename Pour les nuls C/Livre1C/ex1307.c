...
int main()
{
    ...
    match=strcmp(tabsaisie,motpasse);//compare les deux var des val de tabsaisie est motdepasse avec la var match et la fonction strcmp qui lui renvoie 0 quand les deux val des var correspondes.
    if (match==0)
