...
/*Fonction de definition pour busy()*/
void busy()
{
    printf("Appel de la fonction busy !\n");
}
...
Cela en restant a l'interieur de la fonction busy qui est appeller par la suite par sa fonction de definition qui vas chercher la boucle busy directement
Ici les fonctions prototype sont effacer pour voir la réaction du programme en cas de conflit dans un reel oublie de ses dernieres.
*/