...
int main()
{
    ...
    if (strcmp(tabsaisie,motpasse)==0)//compare les deux var des val de tabsaisie est motdepasse avec la var match et la fonction strcmp qui lui renvoie 0 quand les deux val des var correspondes.
